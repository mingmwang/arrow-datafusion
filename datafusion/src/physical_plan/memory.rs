...
mod tests {
    ...
    async fn test_with_projection() -> Result<()> {
        ...
        let executor = MemoryExec::try_new(&[vec![batch]], schema, Some(vec![2, 1]), "sess_123".to_owned())?;
    ...
    async fn test_without_projection() -> Result<()> {
        ...
        let executor = MemoryExec::try_new(&[vec![batch]], schema, None, "sess_123".to_owned())?;
        let statistics = executor.statistics();
